        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
          ...
          <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <a href="https://www.instagram.com/sharetogo_/?igshid=MjEwN2IyYWYwYw%3D%3D" className="flex justify-center items-center text-white hover: hover:text-teal-700 focus:text-green-800" aria-label="Instagram">
              ...
              <li className="ml-4">
                <a href="https://www.tiktok.com/@share2go" className="flex justify-center items-center text-white hover: hover:text-teal-700 focus:text-green-800" aria-label="Tiktok">
                  <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
              ...
              <li className="ml-4">
                <a href="https://twitter.com/Sharetogo_" className="flex justify-center items-center text-white hover: hover:text-teal-700 focus:text-green-800" aria-label="Twitter">
                  <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">

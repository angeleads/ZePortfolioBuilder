      ...
      <div className="relative container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8">
            ...
            <p
              className={`text-xl text-purple-100/80 transform transition-all duration-1000 delay-300
              ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
            ...
            >
              A futuristic project management tool designed to revolutionize how
              you build, manage, and showcase your portfolio projects.
            </p>
            ...
            >
              <Link
                href="/auth"
                className="group relative inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full text-white font-semibold overflow-hidden transition-all duration-300 hover:scale-105"
              >
              ...
              <Link
                href="https://github.com/angeleads/ZePortfolioBuilder"
                className="group inline-flex items-center gap-2 px-8 py-4 rounded-full text-white font-semibold border border-purple-500/30 hover:border-purple-500 transition-all duration-300"
              >
              ...
              <div className="relative bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/20">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="p-6 rounded-xl bg-purple-900/30 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
                    >

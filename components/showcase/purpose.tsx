...
import { Layout, Users, Workflow } from "lucide-react";
  ...
  const features = [
    {
      ...
      description:
        "User-friendly design that enhances productivity and reduces learning curve",
    },
    {
      icon: Users,
      title: "Project Management",
      description:
        "Powerful tools to keep your projects organized and on track",
    },
    {
      icon: Workflow,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <div className="relative group">
              ...
              <div className="relative aspect-square rounded-full overflow-hidden border-4 border-purple-300/20 backdrop-blur-sm"></div>
            </div>
          </div>
          <div className="lg:w-1/2">

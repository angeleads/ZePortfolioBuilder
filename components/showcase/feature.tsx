  ...
  const features = [
    {
      ...
      description:
        "Manage multiple projects with ease. Create, edit, and delete projects as needed with our intuitive interface.",
    ...
    },
    {
      ...
      description:
        "Real-time collaboration with team members. Assign tasks, track progress, and communicate effectively.",
    ...
    },
    {
      ...
      description:
        "Personalize your workspace with customizable widgets, charts, and visualizations to stay informed.",
    ...
    >
      ...
      <div className="relative container mx-auto px-6">
        <div className="text-center mb-20">
          <h2
            className={`text-5xl font-bold bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent mb-6 
          ...
          >
            Experience the next generation of portfolio management with our
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="relative group">
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${feature.bgClass} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500`}
                ></div>

                <div
                  className="relative bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/20 
